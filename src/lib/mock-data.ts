...
export const brokers: Broker[] = [
  ...
  },
  {
    ...
    cta: "Open ING Depot",
    url: "https://www.ing.de/sparen-anlegen/direkt-depot/",
    regions: ["de"],
    sparplan: true,
    sparplanMin: "€1",
  },
  ...
  },
  {
    ...
    logo: "CB",
    fractional: false,
    commission: "€4.95 + 0.25%",
    minDeposit: "€0",
    features: [
      "BNP Paribas subsidiary",
      "Sparplan from €10/month",
      "Wide selection of stocks & ETFs",
      "German BaFin regulated",
    ],
    cta: "Open Consorsbank Depot",
    url: "https://www.consorsbank.de/ev/Wertpapierhandel/Depot-Software/Depot",
    regions: ["de"],
    sparplan: true,
    sparplanMin: "€10",
  },
  {
    ...
    features: [
      "Commission-free trading",
      "Sparplan from €1/month",
      "Over 6,000 stocks & ETFs",
      "German BaFin regulated",
    ],
    cta: "Open finanzen.net zero",
